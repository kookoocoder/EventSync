  ...
  return (
    <section className="relative">
      ...
      <div className="relative bg-[url('/placeholder.svg?height=800&width=1600')] bg-cover bg-center">
        <div className="container flex flex-col items-center justify-center space-y-8 py-24 text-center md:py-32 lg:py-40">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold tracking-tighter text-white sm:text-5xl md:text-6xl lg:text-7xl">
              Innovate. Create. Collaborate.
            </h1>
            <p className="mx-auto max-w-[700px] text-lg text-white/90 md:text-xl">
              Join the most exciting hackathons and turn your ideas into reality. Connect with like-minded innovators
